            ...
            <div className="p-6 bg-none border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 justify-center" style={{ backdropFilter: "blur(8px)", marginTop: "-200px"}}>
                <div className="flex flex-col justify-center items-center">
                    ...
                    <Link href="/ConnectWallet">
                        <div className={"inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center rounded-lg focus:outline-none focus:ring-4 dark:focus:ring-primary-900 " + (isLinkActive("/ConnectWallet") ? "bg-gray-800 text-white hover:bg-gray-900 focus:ring-primary-300" : "bg-gray-800 text-yellow-400 hover:bg-gray-700 focus:ring-gray-100 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700")}>
                        Connect wallet
                        </div>
                    </Link>
                    </div>
