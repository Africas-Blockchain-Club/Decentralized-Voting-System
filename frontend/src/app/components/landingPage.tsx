    ...
    <Layout>
        <section className="h-full w-full bg-base dark:bg-base-100 flex justify-center items-center">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                ...
                <p className="mb-8 text-lg font-normal text-primary lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">A decentralized voting app. Giving you Security and Transparency</p>
