...
const NavBar = () => {
  ...
  return (
        <nav className="bg-base-100 border-base-100 dark:bg-base-100">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="hidden bg-base-100 w-full md:block md:w-auto" id="navbar-default">
              <ul className="font-medium flex bg-base-100 flex-col p-4 md:p-0 mt-4 border border-base-100 rounded-lg dark:bg-base-100 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-base md:dark:bg-base-100 dark:border-gray-700">
                <li>
