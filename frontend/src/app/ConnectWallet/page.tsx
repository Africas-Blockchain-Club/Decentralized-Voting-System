...
const ConnectWallet= () => {
    ...
    return(
        ...
        <span className="flex-1 ms-3 whitespace-nowrap"onClick={connect}>MetaMask</span>
        ...
        <li>
        <a href="/" className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-primary hover:bg-gray-100 group hover:shadow dark:bg-primary dark:hover:bg-gray-500 dark:text-white">
        <span className="flex-1 ms-3 whitespace-nowrap">Cancel</span>
        </a>
        </li>
        </ul>
        <div>
